package cnrs.lattice.engines.mate;
...
public class DependencyParser  {
 //   final static private Logger LOGGER = Logger.getLogger(DependencyParser.class);
    ...
    public void setParserFile(String parserFile){
    	File fi = new File(parserFile);
    	this.parserFile = fi;
    }
    
    public void setTaggerFile(String taggerFile){
    	File fi = new File(taggerFile);
    	this.taggerFile = fi;
    }
    
    public void setLemmatizerFile(String lemmatizerFile){
    	File fi = new File(lemmatizerFile);
    	this.lemmatizerFile = fi;
    }
    //@Override
